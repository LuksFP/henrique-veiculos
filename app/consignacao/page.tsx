...
function buildMsg(data: Record<string, string>) {
  const lines = ["Olá, vim pelo site e quero solicitar *Consignação de Veículo*:"];
  ...
  if (data.vehicle_cor) lines.push(`Cor: ${data.vehicle_cor}`);
                ...
                <form className="sp-form" onSubmit={handleSubmit}>
                  <fieldset className="sp-fieldset">
                    ...
                    <div className="sp-fields">
                      ...
                      <div className="sp-field"><label>Modelo</label><input name="vehicle_modelo" placeholder="Ex: Civic" /></div>
                      <div className="sp-field"><label>Ano/Modelo</label><input name="vehicle_ano" placeholder="Ex: 2020/2021" /></div>
                      <div className="sp-field"><label>Quilometragem</label><input name="vehicle_km" placeholder="Ex: 42000" /></div>
                      <div className="sp-field"><label>Cor</label><input name="vehicle_cor" placeholder="Ex: Prata" /></div>
                  ...
                  <fieldset className="sp-fieldset">
                    ...
                    <div className="sp-fields">
                      ...
                      <div className="sp-field sp-field--wide"><label>Informações adicionais</label><textarea name="notes" rows={3} placeholder="Acessórios, revisões, estado geral do veículo..." /></div>
                    </div>
                  </fieldset>
